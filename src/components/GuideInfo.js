        ...
        <div className="container">
            <div className="columns">
                <div className="column">
                    <h1 className="">Our guide to launching a successful digital product.</h1>
                    <p>Read our 8 Secrets to designing, building and launching successful digital products.</p>
